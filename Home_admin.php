...
<body>
                ...
                <div class="single_gallery">
                    ...
                    <div class="gallery_hover">
                            <div class="hover_inner">
                                    ...
                                    <a href="\"> <h3>(add,delete...)</h3></a>
                            </div>
                        </div>
                </div>
                <div class=" single_gallery small_width">
                    <div class="thumb">
                         <button id ="managU" class="button1"> <img src="img/logout1.png"></button>
                    </div>
                    <div class="gallery_hover">
                            <div class="hover_inner">
                                    <span>Manage Users</span>
                                    <a href="ManageUsers.php"> <h3></h3></a>
                            </div>
                        </div>
    ...
    document.getElementById("map1").onclick = function () {
        location.href = "ManageTrip_admin.php";
    };
	
	document.getElementById("wallet").onclick = function () {
        location.href = "Charging_admin.php";
    };
	document.getElementById("ViewS").onclick = function () {
        location.href = "Station_admin.php";
    };
	document.getElementById("managS").onclick = function () {
        location.href = "ManageStations.php";
    };
	document.getElementById("managu").onclick = function () {
