            ...
            <div class="portfolio_wrap">
                ...
                <div class="single_gallery small_width">
                    ...
                    <div class="gallery_hover">
                            <div class="hover_inner">
                                    <span>   </span>
                                    <a href="Charging.php"> <h3>Charging Wallet</h3></a>
                            </div>
                        </div>
                </div>
                <div class="single_gallery">
                    <div class="thumb">
                         <button id ="map" class="button1"> <img src="img/train-station.png"></button>
                    </div>
                    <div class="gallery_hover">
                            <div class="hover_inner">
                                    <span></span>
                                    <a href="work_details.html"> <h3>setting</h3></a>
                            </div>
                        </div>
                </div>
                <div class=" single_gallery">
                    ...
                    <div class="gallery_hover">
                            <div class="hover_inner">
                                    <span></span>
                                    <a href="work_details.html"> <h3>your QR</h3></a>
                            </div>
                        </div>
                </div>
                <div class="single_gallery">
                    <div class="thumb">
                         <button id ="map" class="button1"> <img src="img/icons8-services-500.png"></button>
                    </div>
                    <div class="gallery_hover">
                            <div class="hover_inner">
